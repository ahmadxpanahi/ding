...
class DetailedReportBloc extends Bloc<DetailedReportEvent,DetailedReportState>{
  DetailedReportBloc() : super(DeReportInitialState());

  @override
  Stream<DetailedReportState> mapEventToState(DetailedReportEvent event) async*{
