              ...
              Column(
                ...
                children: [
                  Text(
                    beginDate ?? '',
                    style:
                        TextStyle(fontSize: 4.0.rw, color: DingColors.dark()),
                  ),
                  Text(
                    endDate ?? '',
                    style:
            ...
            ? Row(
                children: [
                  ...
                  Text(
                    'نمایش جزءیات',
                    style: TextStyle(
                        fontSize: 4.0.rw, color: DingColors.primary()),
                  )
                ],
              )
            : Row(
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        beginDate ?? '',
                        style: TextStyle(
                            fontSize: 4.0.rw, color: DingColors.dark()),
                      ),
                      Text(
                        endDate ?? '',
                        style: TextStyle(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              name ?? '',
                              style: TextStyle(
                                  color: DingColors.dark(), fontSize: 4.0.rw),
                            ),
                            Text(
                              unit ?? '',
                              style: TextStyle(
                                  color: Colors.grey, fontSize: 4.0.rw - 2),
                            ),
                          ],
                        ),
                      ),
