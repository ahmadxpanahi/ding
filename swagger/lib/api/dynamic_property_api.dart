...
class DynamicPropertyApi {
  ...
  Future apiServicesAppDynamicpropertyAddPost({ DynamicPropertyDto? body }) async {
    ...
    String path = "/api/services/app/DynamicProperty/Add".replaceAll("{format}","json");
 ...
 if(response == null) return null;
  ...
  Future apiServicesAppDynamicpropertyDeleteDelete({ int? id }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/DynamicProperty/Delete".replaceAll("{format}","json");
 ...
 if(response == null) return null;
  ...
  Future<IInputType?> apiServicesAppDynamicpropertyFindallowedinputtypePost({ String? name }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/DynamicProperty/FindAllowedInputType".replaceAll("{format}","json");
 ...
 if(response == null) return null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'IInputType') as IInputType ;
    } else {
      return null;
    }
  }
  ...
  Future<DynamicPropertyDto?> apiServicesAppDynamicpropertyGetGet({ int? id }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/DynamicProperty/Get".replaceAll("{format}","json");
 ...
 if(response == null) return null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'DynamicPropertyDto') as DynamicPropertyDto ;
    } else {
      return null;
    }
  }
  ...
  Future<ListResultDtoOfDynamicPropertyDto?> apiServicesAppDynamicpropertyGetallGet() async {
    ...
    // create path and map variables
    String path = "/api/services/app/DynamicProperty/GetAll".replaceAll("{format}","json");
 ...
 if(response == null) return null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ListResultDtoOfDynamicPropertyDto') as ListResultDtoOfDynamicPropertyDto ;
    } else {
      return null;
    }
  }
  ...
  Future apiServicesAppDynamicpropertyUpdatePut({ DynamicPropertyDto? body }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/DynamicProperty/Update".replaceAll("{format}","json");
