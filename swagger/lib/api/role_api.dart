...
class RoleApi {
  ...
  Future apiServicesAppRoleCreateorupdaterolePost({ CreateOrUpdateRoleInput? body }) async {
    ...
    String path = "/api/services/app/Role/CreateOrUpdateRole".replaceAll("{format}","json");
 ...
 if(response == null) return null;
  ...
  Future apiServicesAppRoleDeleteroleDelete({ int? id }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/Role/DeleteRole".replaceAll("{format}","json");
 ...
 if(response == null) return null;
  ...
  Future<ListResultDtoOfRoleListDto?> apiServicesAppRoleGetrolesGet({ List<String>? permissions }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/Role/GetRoles".replaceAll("{format}","json");
 ...
 if(response == null) return null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ListResultDtoOfRoleListDto') as ListResultDtoOfRoleListDto ;
    } else {
      return null;
    }
  }
