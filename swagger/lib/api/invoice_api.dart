...
class InvoiceApi {
  ...
  ///
  /// 
  Future apiServicesAppInvoiceCreateinvoicePost({ CreateInvoiceDto? body }) async {
    Object? postBody = body;

    // verify required params are set

    // create path and map variables
    String path = "/api/services/app/Invoice/CreateInvoice".replaceAll("{format}","json");
  ...
  Future<InvoiceDto?> apiServicesAppInvoiceGetinvoiceinfoGet({ int? id }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/Invoice/GetInvoiceInfo".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'InvoiceDto') as InvoiceDto ;
    } else {
      return null;
    }
  }
