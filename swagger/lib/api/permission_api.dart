...
class PermissionApi {
  ...
  Future<ListResultDtoOfFlatPermissionWithLevelDto?> apiServicesAppPermissionGetallpermissionsGet() async {
    ...
    String path = "/api/services/app/Permission/GetAllPermissions".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ListResultDtoOfFlatPermissionWithLevelDto') as ListResultDtoOfFlatPermissionWithLevelDto ;
    } else {
      return null;
    }
  }
