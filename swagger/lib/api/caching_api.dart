...
class CachingApi {
  ...
  Future apiServicesAppCachingClearallcachesPost() async {
    ...
    String path = "/api/services/app/Caching/ClearAllCaches".replaceAll("{format}","json");
  ...
  Future apiServicesAppCachingClearcachePost({ EntityDtoOfString? body }) async {
    ...
    // create path and map variables
    String path = "/api/services/app/Caching/ClearCache".replaceAll("{format}","json");
  ...
  Future<ListResultDtoOfCacheDto> apiServicesAppCachingGetallcachesGet() async {
    ...
    // create path and map variables
    String path = "/api/services/app/Caching/GetAllCaches".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ListResultDtoOfCacheDto') as ListResultDtoOfCacheDto ;
    } else {
      return null;
    }
  }
